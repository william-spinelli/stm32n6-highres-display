...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOQ, LCD_BACKLIGHT_Pin|LCD_ON_OFF_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LCD_BACKLIGHT_Pin LCD_ON_OFF_Pin */
  GPIO_InitStruct.Pin = LCD_BACKLIGHT_Pin|LCD_ON_OFF_Pin;
